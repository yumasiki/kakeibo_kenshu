...
from .views import PaymentList, IncomeList, PaymentCreate, IncomeCreate,PaymentCategoryCreate ,PaymentUpdate, IncomeUpdate, PaymentDelete, IncomeDelete, MonthDashboard
...
urlpatterns = [
    ...
    path("payment_category_create/", PaymentCategoryCreate.as_view(), name="payment_category_create"),
